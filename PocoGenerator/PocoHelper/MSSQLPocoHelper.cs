...
namespace PocoGenerator.PocoHelper
{
    public class MSSQLPocoHelper : IPocoHelper
    {
        ...
        public DataView GetColumnList(string tableID)
        {
            ...
            query.AppendLine(@"	ISNULL(I.is_identity,0) IsIdentity");
            ...
            query.AppendLine(@"LEFT JOIN sys.columns I WITH(NOLOCK)");
            query.AppendLine(@"	ON I.object_id = A.id AND I.is_identity = 1 AND A.Name = I.name");
